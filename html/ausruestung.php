...
<html lang="en">
  <head>
    ...
    <title>Ingressy | Ausrüstung</title>
  ...
  <body class="bg-dark">
    ...
    <div class="card bg-dark text-white">
      <div class="card-body">
        <h5>Digitale Endgeräte:</h5>
        <h6>Laptop:</h6>
        <p>
          Lenovo T480<br>
          i5-8350U | 16 GB | 500GB SSD + 128GB NVME<br>
          mit Windows 11 und Arch Linux
        </p>
        <h6>PC:</h6>
        <p>
          CPU: Ryzen 5 3600<br>
        ...
        <p>
          drei KVMs mit insgesamt:<br>
          6 Kern, 24GB RAM, 180GB SSD<br>
          für Mailcow, Docker und Pterodactyl
        </p>
        <h6>Home Krams:</h6>
        <p>
